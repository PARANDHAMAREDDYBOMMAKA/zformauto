...
public class TestPage4 {
    public static void main(String[] args) {
        ...
        try {
            ...
            slider5.click();
            System.out.println("Engagement slider set to 5");
            System.out.println("Page 3 completed");

            WebElement nextButton3 = driver.findElement(By.xpath("//*[@id='formBodyDiv']/div[7]/div[3]/div[1]/div[2]/button"));
            nextButton3.click();
            Thread.sleep(3000);
            ...
            slider2_5.click();
            System.out.println("Productivity slider set to 5");
            System.out.println("Page 4 completed");

            WebElement nextButton4 = driver.findElement(By.xpath("//*[@id='formBodyDiv']/div[7]/div[4]/div[1]/div[2]/button"));
            nextButton4.click();
            Thread.sleep(3000);
